...
impl Developers {
    pub fn new(code: i32, status: String, remaining_monthly_allowance: i32, extra_allowance: i32, allowance_refresh_timer: Option<i32>, data: crate::models::DevelopersAllOfData) -> Developers {
        Developers {
            code,
            status,
