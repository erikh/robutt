...
impl GamesByGameId {
    pub fn new(code: i32, status: String, remaining_monthly_allowance: i32, extra_allowance: i32, pages: crate::models::PaginatedApiResponseAllOfPages, data: crate::models::GamesByGameIdAllOfData) -> GamesByGameId {
        GamesByGameId {
            code,
            status,
